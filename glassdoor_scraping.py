...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
    ...
    # Uncomment the line below if you'd like to scrape without a new Chrome
    # window every time.
    ...
    driver.set_window_size(1120, 1200)
    ...
    while len(jobs) < num_jobs:
        ...
        try:
            driver.find_element_by_class_name(
                "main flex loggedOut lang-de de-DE hollywood wide hasTwoPanes _initOk serpControl").click()
        except NoSuchElementException:
            pass
            ...
            try:
                ...
                try:
                    ...
                    headquarters = driver.find_element_by_xpath(
                        './/div[@class="infoEntity"]//label[text()="Hauptsitz"]//following-sibling::*').text
                except NoSuchElementException:
                    headquarters = -1
                ...
                try:
                    type_of_ownership = driver.find_element_by_xpath(
                        './/div[@class="infoEntity"]//label[text()="Art"]//following-sibling::*').text
                except NoSuchElementException:
                    type_of_ownership = -1
                ...
                try:
                    competitors = driver.find_element_by_xpath(
                        './/div[@class="infoEntity"]//label[text()="Konkurrenten"]//following-sibling::*').text
                except NoSuchElementException:
                    competitors = -1
